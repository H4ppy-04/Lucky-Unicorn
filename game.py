...
local = {
	...
	"highest_currency": 0,
	"goodbye_quit":
	"Sorry to see you go. Here\'s some of your final statistics:",
...
while balance >= 1.0:
	...
	try:
		...
		if not token:
			...
			print(
				f"You got a ${str(tokens[token]['value'])} {token.capitalize()}! \n "
			)
			print(
...
print(f"""You played {str(local['games_played'])} round(s)
